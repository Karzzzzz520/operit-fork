const ForkApiDevInstallerState = {
  logs: []
};

const ForkApiDevInstaller = (function () {
  const ENVIRONMENT = "android";
  const SKILL_NAME = "ForkAPI_DEV";
  ...
  const CDN_BASE = "https://cdn.jsdelivr.net/gh/Karzzzzz520/operit-fork@main";
  ...
  const DOWNLOADS = [
    {
      url: `${CDN_BASE}/docs/FORK_API_SKILL.md`,
      destination: `${SKILL_ROOT}/SKILL.md`
    },
    {
      url: `${CDN_BASE}/docs/developer-api/FORK_CAPABILITIES.md`,
      destination: `${REFERENCES_DIR}/FORK_CAPABILITIES.md`
    },
    {
      url: `${CDN_BASE}/docs/developer-api/ARCHITECTURE.md`,
      destination: `${REFERENCES_DIR}/ARCHITECTURE.md`
    },
    {
      url: `${CDN_BASE}/docs/developer-api/OAUTH_SANDBOX_BRIDGE.md`,
      destination: `${REFERENCES_DIR}/OAUTH_SANDBOX_BRIDGE.md`
    },
    {
  ...
  function logStep(message) {
    ForkApiDevInstallerState.logs.push(message);
    console.log(message);
  }
  ...
  async function run() {
    ...
    return {
      ...
      data: {
        ...
        logs: ForkApiDevInstallerState.logs
      }
    };
  }
